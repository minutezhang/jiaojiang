...
public class CircularArrayLoop {
    /**
     * You are playing a game involving a circular array of non-zero integers nums. Each nums[i] denotes the number
     * of indices forward/backward you must move if you are located at index i:
     *
